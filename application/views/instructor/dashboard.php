    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="bg-white rounded-xl shadow-md p-6 mb-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <a href="<?= base_url('instructor/create_course') ?>" class="flex items-center justify-center bg-gradient-to-br from-indigo-600 to-indigo-700 hover:from-indigo-700 hover:to-indigo-800 text-white rounded-lg p-4 transition-all transform hover:scale-105">
                ...
                <a href="<?= base_url('instructor/courses') ?>" class="flex items-center justify-center bg-gradient-to-br from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white rounded-lg p-4 transition-all transform hover:scale-105">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="bg-white rounded-xl shadow-md p-6">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="<?= base_url('instructor/create_course') ?>" class="bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-700 hover:to-indigo-800 text-white text-sm py-2.5 px-4 rounded-lg shadow-sm hover:shadow transition-all flex items-center">
            ...
            <?php else: ?>
                            ...
                            <div class="p-4 bg-white">
                                ...
                                <div class="border-t border-gray-200 pt-4">
                                    <div class="flex flex-wrap gap-2 mb-4">
                                        <a href="<?= base_url('instructor/lessons/' . $course->id) ?>" class="inline-flex items-center px-3 py-1.5 bg-indigo-100 text-indigo-700 text-xs font-medium rounded-lg border border-indigo-200 hover:bg-indigo-200">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                            </svg>
                                            Lessons
                                        </a>
                                        <a href="<?= base_url('instructor/quizzes/' . $course->id) ?>" class="inline-flex items-center px-3 py-1.5 bg-purple-100 text-purple-700 text-xs font-medium rounded-lg border border-purple-200 hover:bg-purple-200">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                            </svg>
                                            Quizzes
                                        </a>
                                        <a href="<?= base_url('instructor/course_analytics/' . $course->id) ?>" class="inline-flex items-center px-3 py-1.5 bg-green-100 text-green-700 text-xs font-medium rounded-lg border border-green-200 hover:bg-green-200">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <div class="grid grid-cols-3 gap-2">
                                        <a href="<?= base_url('home/course/' . $course->id) ?>" class="inline-flex items-center justify-center px-3 py-2 bg-blue-50 text-blue-700 text-xs font-medium rounded-lg border border-blue-200 hover:bg-blue-100">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <a href="<?= base_url('instructor/edit_course/' . $course->id) ?>" class="inline-flex items-center justify-center px-3 py-2 bg-indigo-50 text-indigo-700 text-xs font-medium rounded-lg border border-indigo-200 hover:bg-indigo-100">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                            </svg>
                                            Edit
                                        </a>
                                        <a href="<?= base_url('instructor/delete_course/' . $course->id) ?>" class="inline-flex items-center justify-center px-3 py-2 bg-red-50 text-red-700 text-xs font-medium rounded-lg border border-red-200 hover:bg-red-100" onclick="return confirm('Are you sure you want to delete this course?')">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="mt-8 text-center">
                    <a href="<?= base_url('instructor/courses') ?>" class="inline-flex items-center px-4 py-2 bg-indigo-50 text-indigo-700 text-sm font-medium rounded-lg border border-indigo-200 hover:bg-indigo-100">
