...
<div class="bg-white shadow rounded-lg p-6 mb-6">
    <div class="flex items-center justify-between">
        ...
        <a href="<?= base_url('student/profile') ?>" class="bg-gray-50 text-gray-700 px-4 py-2 rounded-lg shadow-sm hover:shadow hover:bg-gray-100 transition-all transform hover:scale-102">
