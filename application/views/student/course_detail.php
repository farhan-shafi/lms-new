                    ...
                    <div class="flex items-center">
                        <div class="flex items-center">
                            <?php for ($i = 1; $i <= 5; $i++): ?>
                                ...
                                <?php endif; ?>
                            <?php endfor; ?>
                            <span class="ml-1"><?= number_format($course->average_rating, 1) ?> (<?= $course->rating_count ?> reviews)</span>
                        </div>
                    </div>
                    <?php endif; ?>
                    <div class="flex items-center">
            ...
            <?php else: ?>
                ...
                <div class="border-b border-gray-200 mb-6">
                    <nav class="-mb-px flex space-x-8">
                        <a href="#lessons" class="border-blue-500 text-blue-600 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                            Lessons
                        </a>
                        <?php if ($is_enrolled): ?>
                        <a href="<?= base_url('student/quizzes/' . $course->id) ?>" class="border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm flex items-center">
                            Quizzes
                            <span class="ml-2 bg-blue-100 text-blue-800 text-xs font-medium px-2.5 py-0.5 rounded-full">Test Your Knowledge</span>
                        </a>
                        <?php endif; ?>
                    </nav>
                </div>
            ...
            <div class="space-y-3">
                <a href="<?= base_url('student/quizzes/' . $course->id) ?>" class="flex items-center justify-between p-3 bg-blue-50 text-blue-700 hover:bg-blue-100 rounded-lg transition-all transform hover:scale-102 shadow-sm hover:shadow">
                    <div class="flex items-center">
                        ...
                        <span class="font-medium">Take Quizzes</span>
                    </div>
                    <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                    </svg>
                </a>
                <a href="<?= base_url('student/rate_course/' . $course->id) ?>" class="flex items-center text-blue-600 hover:text-blue-800">
                    <svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
