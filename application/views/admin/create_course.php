<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        <?= form_open('admin/create_course', array('class' => 'space-y-6')) ?>
            ...
            <div>
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
                       id="title" name="title" type="text" placeholder="Course Title" value="<?= set_value('title') ?>" required>
            </div>
            ...
            <div>
                ...
                <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
                          id="description" name="description" rows="4" placeholder="Course description..."><?= set_value('description') ?></textarea>
            </div>
                ...
                <div>
                    ...
                    <select class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
                        ...
                        <?php foreach ($instructors as $instructor): ?>
                            <option value="<?= $instructor->id ?>" <?= set_select('instructor_id', $instructor->id) ?>>
