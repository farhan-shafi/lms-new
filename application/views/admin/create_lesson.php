<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-3xl font-bold text-gray-800">Create New Lesson</h1>
    ...
    <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        <?= form_open('admin/create_lesson/' . $course->id, array('class' => 'space-y-6')) ?>
            ...
            <div>
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
                       id="title" name="title" type="text" placeholder="Lesson Title" value="<?= set_value('title') ?>" required>
            </div>
            ...
            <div>
                ...
                <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
                          id="content" name="content" rows="8" placeholder="Lesson content..."><?= set_value('content') ?></textarea>
            </div>
            ...
            <div>
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
                       id="video_url" name="video_url" type="url" placeholder="https://www.youtube.com/watch?v=..." value="<?= set_value('video_url') ?>">
            ...
            <div>
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
                       id="sort_order" name="sort_order" type="number" placeholder="0" value="<?= set_value('sort_order', '0') ?>" min="0">
