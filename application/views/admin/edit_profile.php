...
<div class="bg-white shadow rounded-lg p-6">
    <?= form_open_multipart('admin/edit_profile', ['class' => 'space-y-6']) ?>
        ...
        <div>
            ...
            <div class="mb-6">
                ...
                <p class="text-sm text-gray-500 mt-1">Optional: Share a brief description about yourself and your administrative role.</p>
